  ...
  return (
    <div className="relative -my-8 sm:-my-10">
        ...
        <div className="mx-auto grid w-full max-w-question grid-cols-2 gap-x-6 gap-y-5 px-4 py-8 sm:grid-cols-4">
          {[
            ...
            <Reveal key={f.label} delay={i * 80} className="grow">
              <p className="grow-figure font-mono text-xl text-ink-strong">
                {f.figure}
              </p>
              <p className="grow-label mt-1 text-xs leading-snug text-ink/60">
                {f.label}
              </p>
            </Reveal>
          ))}
          ...
          <Reveal className="mt-6">
            <div className="rounded-card border border-line bg-raised p-4 shadow-card">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="font-mono text-lg font-semibold tabular-nums text-ink-strong">
                  1:47:05
                </span>
              </div>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <span className="flex overflow-hidden rounded-card border border-line text-xs">
                  <span className="bg-brand px-2.5 py-1 text-on-brand">
                    SBAs · 50
                  </span>
                  <span className="border-l border-line px-2.5 py-1 text-ink/70">
                    EMQs · 50
                  </span>
                </span>
                <span className="rounded-card border border-warn/60 px-2.5 py-1 font-mono text-xs text-warn">
                  Flagged · 4
                </span>
              </div>
            </div>
      ...
      <Reveal as="section" className="py-14" anchor="pricing">
        ...
        <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink/70">
      ...
      <section
        data-journey="start"
        className="bleed border-t border-line bg-surface"
      >
